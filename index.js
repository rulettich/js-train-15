...
function calculateHypotenuse(a, b) {
  ...
  if (typeof a !== "number" || typeof b !== "number") {
    console.error("Помилка: значення повинно бути числом");
    return null;
  }

  let hypotLenth = Math.hypot(a, b);
...
function roundObjectValues(obj) {
  ...
  if (typeof obj !== "object" || typeof obj === null) {
    console.error("Помилка: аргумент повинен бути об'єктом");
...
function calculateVolumeCylinder(radius, height) {
  ...
  if (typeof radius !== "number" || typeof height !== "number") {
    console.error("Помилка: значення повинні бути числом");
    return null;
  }

  let volumeOfCylinder = Math.PI * Math.pow(radius, 2) * height;
  const result = Math.ceil(volumeOfCylinder);
...
function estimateInvestment(principal, interestRate, years) {
  ...
  if (
    ...
    console.error("Помилка: аргумент повинен бути числом");
...
function isTotalPriceExceedsMaxPrice(products, maxPrice) {
  ...
  if (!Array.isArray(products)) {
    console.error("Помилка: аргумент повинен бути масивом");
